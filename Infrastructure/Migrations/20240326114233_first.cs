...
namespace Infrastructure.Migrations
{
    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DepartmanMeslek",
                columns: table => new
                {
                    DepartmanlarId = table.Column<int>(type: "int", nullable: false),
                    MesleklerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmanMeslek", x => new { x.DepartmanlarId, x.MesleklerId });
                    table.ForeignKey(
                        name: "FK_DepartmanMeslek_Departmanlar_DepartmanlarId",
                        column: x => x.DepartmanlarId,
                        principalTable: "Departmanlar",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmanMeslek_Meslekler_MesleklerId",
                        column: x => x.MesleklerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmanSirket", x => new { x.DepartmanlarId, x.SirketlerId });
                    table.ForeignKey(
                        name: "FK_DepartmanSirket_Departmanlar_DepartmanlarId",
                        column: x => x.DepartmanlarId,
                        principalTable: "Departmanlar",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmanSirket_Sirketler_SirketlerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmanMeslek_MesleklerId",
                table: "DepartmanMeslek",
                column: "MesleklerId");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmanSirket_SirketlerId",
                table: "DepartmanSirket",
                column: "SirketlerId");
